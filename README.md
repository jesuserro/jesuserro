...
<table>
  <tr>
    <td style="vertical-align: top; width: 50%; padding-right: 10px;">
<strong>✅ A/B Testing for UI/UX Redesign</strong>: Data-driven experiments focused on improving usability and user experience through interface redesign — <a href="https://github.com/jesuserro/ab-testing-ui-redesign-vanguard">optimizing user interfaces</a>.
<div style="display: flex; gap: 4px; margin-top: 6px;">
  ...
  <img src="https://github.com/jesuserro/ab-testing-ui-redesign-vanguard/raw/main/img/4_activity_by_day.jpg" width="100" height="67" style="object-fit: cover;">
    ...
    <td style="vertical-align: top; width: 50%; padding-left: 10px;">
<strong>🦈 Shark Attack Analysis</strong>: Uncovering global patterns and insights from shark attack data — <a href="https://github.com/jesuserro/shark-attack-exploratory-data-analysis">exploratory data analysis</a>.
...
<div style="display: flex; gap: 4px; margin-top: 6px;">
  ...
  <tr>
    <td colspan="2" style="vertical-align: top; padding-top: 20px;">
<strong>🏆 Oscars Data Insights</strong>: Historical analysis of trends, winners, and cultural shifts in Academy Awards history — <a href="https://github.com/jesuserro/oscars-data-insights-96-years">96 years of film awards</a>.
<div style="display: flex; gap: 4px; margin-top: 6px;">
...
<strong>🧩 Escape Room Game</strong>: A text-based puzzle game showcasing Python logic, control flow, and user interaction — <a href="https://github.com/jesuserro/escape-room-game-python">Python project</a>.
