...
- 📊 **Data Analytics**:  
  ...
  - 🛒 **Retail Sales Predictor**: [XGBRegressor Model](https://github.com/jesuserro/ml-retail-sales-predictor) for training, evaluating, and reporting a machine learning model that predicts store sales.
